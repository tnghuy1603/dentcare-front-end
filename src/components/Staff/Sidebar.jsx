    ...
    return (
        <section className="active" id="menu">
            ...
            <div className="items">
                ...
                <li onClick={() => handleClickSelected(2)} style={getLiStyle(2)}><i className="fa-solid fa-users"></i><Link to={"/manage-patients"}>Patient profiles</Link></li>
                ...
                <li onClick={() => handleClickSelected(4)} style={getLiStyle(4)}><i className="fa-solid fa-calendar-days"></i><Link to={"/view-schedules"}>Schedules</Link></li>
                <li onClick={() => handleClickSelected(5)} style={getLiStyle(5)}><i className="fa-solid fa-stethoscope"></i><Link to={"/view-drugs"}>Drugs</Link></li>
